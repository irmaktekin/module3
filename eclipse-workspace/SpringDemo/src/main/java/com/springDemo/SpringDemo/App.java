...
public class App 
{
    public static void main( String[] args )
    {
	    ...
	    */
		...
		Event event2 = new EventImp("event22", new Date());

		//facade.createUser(user);
		facade.createUser(user2);
	//	facade.createEvent(event2);
		facade.createEvent(event);
		facade.bookTicket(2, 1, 5, Ticket.Category.BAR);
		facade.bookTicket(2, 1, 5, Ticket.Category.PREMIUM);
		facade.cancelTicket(1);

	//facade.getBookedTickets(user, 0, 0);
	facade.getBookedTickets(event2, 0, 0);
